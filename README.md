...
| Участник | Функциональность |
|----------|------------------|
| **MaxVolkov-GM** | Функциональность «Рекомендации» |
| **saleevakate** | Удаление фильмов и пользователей; вывод самых популярных фильмов по жанру и годам; функциональность «Лента событий»; функциональность «Поиск» |
| **Somud97** | Функциональность «Отзывы» |
| **MusMur1995** | Добавление режиссёров в фильмы; функциональность «Общие фильмы» |
